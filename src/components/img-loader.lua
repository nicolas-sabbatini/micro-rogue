...
function Loader.walls(x, y, wide, height, table)
	...
	-- Load third row
	quads["01101000"] =
		love.graphics.newQuad(x + (wide * 0), y + (height * 2), wide, height, Loader.img:getDimensions())
	quads["11111000"] =
		love.graphics.newQuad(x + (wide * 1), y + (height * 2), wide, height, Loader.img:getDimensions())
	quads["11010000"] =
		love.graphics.newQuad(x + (wide * 2), y + (height * 2), wide, height, Loader.img:getDimensions())
	quads["01000000"] =
		love.graphics.newQuad(x + (wide * 3), y + (height * 2), wide, height, Loader.img:getDimensions())
	quads["01001011"] =
		love.graphics.newQuad(x + (wide * 4), y + (height * 2), wide, height, Loader.img:getDimensions())
	quads["11011111"] =
		love.graphics.newQuad(x + (wide * 5), y + (height * 2), wide, height, Loader.img:getDimensions())
	quads["01111111"] =
		love.graphics.newQuad(x + (wide * 6), y + (height * 2), wide, height, Loader.img:getDimensions())
	quads["01010110"] =
		love.graphics.newQuad(x + (wide * 7), y + (height * 2), wide, height, Loader.img:getDimensions())
	quads["01011111"] =
		love.graphics.newQuad(x + (wide * 8), y + (height * 2), wide, height, Loader.img:getDimensions())
	quads["01011011"] =
		love.graphics.newQuad(x + (wide * 9), y + (height * 2), wide, height, Loader.img:getDimensions())
	quads["01011110"] =
		love.graphics.newQuad(x + (wide * 10), y + (height * 2), wide, height, Loader.img:getDimensions())
	-- 4
	-- Load fourth row
	quads["00001000"] =
		love.graphics.newQuad(x + (wide * 0), y + (height * 3), wide, height, Loader.img:getDimensions())
	quads["00011000"] =
		love.graphics.newQuad(x + (wide * 1), y + (height * 3), wide, height, Loader.img:getDimensions())
	quads["00010000"] =
		love.graphics.newQuad(x + (wide * 2), y + (height * 3), wide, height, Loader.img:getDimensions())
	quads["00000000"] =
		love.graphics.newQuad(x + (wide * 3), y + (height * 3), wide, height, Loader.img:getDimensions())
	quads["01001000"] =
		love.graphics.newQuad(x + (wide * 4), y + (height * 3), wide, height, Loader.img:getDimensions())
	quads["11011000"] =
		love.graphics.newQuad(x + (wide * 5), y + (height * 3), wide, height, Loader.img:getDimensions())
	quads["01111000"] =
		love.graphics.newQuad(x + (wide * 6), y + (height * 3), wide, height, Loader.img:getDimensions())
	quads["01010000"] =
		love.graphics.newQuad(x + (wide * 7), y + (height * 3), wide, height, Loader.img:getDimensions())
	quads["01011000"] =
		love.graphics.newQuad(x + (wide * 8), y + (height * 3), wide, height, Loader.img:getDimensions())
	quads["01111010"] =
		love.graphics.newQuad(x + (wide * 9), y + (height * 3), wide, height, Loader.img:getDimensions())
	quads["11011010"] =
		love.graphics.newQuad(x + (wide * 10), y + (height * 3), wide, height, Loader.img:getDimensions())
	-- 5
	-- Load fifth row
	quads["01001010"] =
		love.graphics.newQuad(x + (wide * 4), y + (height * 4), wide, height, Loader.img:getDimensions())
	quads["11011110"] =
		love.graphics.newQuad(x + (wide * 5), y + (height * 4), wide, height, Loader.img:getDimensions())
	quads["01111011"] =
		love.graphics.newQuad(x + (wide * 6), y + (height * 4), wide, height, Loader.img:getDimensions())
	quads["01010010"] =
		love.graphics.newQuad(x + (wide * 7), y + (height * 4), wide, height, Loader.img:getDimensions())
	quads["01011010"] =
		love.graphics.newQuad(x + (wide * 8), y + (height * 4), wide, height, Loader.img:getDimensions())
	return quads
end
